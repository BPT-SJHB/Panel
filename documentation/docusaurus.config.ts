...
const config: Config = {
  ...
  url: 'https://doc.barsampazhohesh.ir',
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'سامانه جامع حمل و نقل کالا',
      logo: {
        alt: 'لوگو',
        src: 'img/rmto-logo-dark-noText.svg',
      },
      items: [
        {
          type: 'docSidebar',
        ...
        {
          href: 'https://github.com/BPT-SJHB/Panel',
          label: 'گیت‌هاب',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `ساخته شده توسط شرکت برسام پژوهش`,
    },
    prism: {
