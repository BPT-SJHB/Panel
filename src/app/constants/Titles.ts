...
export class AppTitles {
  ...
  public static readonly footerTitle =
    'کلیه حقوق این وبسایت متعلق به سازمان‌ راهداری و حمل و نقل جاده ای میباشد | نسخه فرانت-اند: 1.68.07 | نسخه بک-اند: 12.2.9 | طراحی و پیاده‌سازی توسط شرکت برسام پژوهش';
