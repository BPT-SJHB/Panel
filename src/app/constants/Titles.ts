...
export class AppTitles {
  ...
  public static readonly footerTitle =
    'کلیه حقوق این وبسایت متعلق به اداره راهداری و حمل و نقل جاده ای استان اصفهان میباشد | نسخه فرانت-اند: 1.68.08 | نسخه بک-اند: 12.2.9 | طراحی و پیاده‌سازی توسط شرکت برسام پژوهش';
