...
export const API_ROUTES = {
  ...
  LoadCapacitorAPI: {
    ...
    GetTransportTariffParamsInJson: `${environment.apiUrl}:${LoadCapacitorPort}/api/GetListofTransportTariffsParams`,
    GetTransportTariffParamsInString: `${environment.apiUrl}:${LoadCapacitorPort}/api/GetTPTParams`,
