...
export const API_ROUTES = {
  SoftwareUserAPI: {
    ...
    UserManagement: {
      ...
      ResetMyPassword: `${environment.apiUrl}:${softwareUserAPIPort}${apiFixURLPart}ResetSoftwareUserPasswordForMe`,
  ...
  TransportationAPI: {
    ...
    Truck: {
      ...
      GetTruckNativenessTypes: `${environment.apiUrl}:${transportationAPIPort}${apiFixURLPart}GetTruckNativenessTypes`,
    ...
    Turns: {
      ...
      CancelMyTurn: `${environment.apiUrl}:${transportationAPIPort}${apiFixURLPart}TurnCancellationForMe`,
      ...
      TurnRegisterRequests: {
        ...
        RealTimeMyTurnRegister: `${environment.apiUrl}:${transportationAPIPort}${apiFixURLPart}RealTimeTurnRegisterRequestForMe`,
  ...
  WalletAndTrafficApi: {
    WalletInfo: {
      ...
      GetMyWalletPaymentRecords: `${environment.apiUrl}:${walletAndTrafficPort}${apiFixURLPart}GetMoneyWalletChargeRecordsForMe`,
  ...
  LoadAllocationAPI: {
    ...
    GetTravelTimeOfMyLoadAllocation: `${environment.apiUrl}:${LoadAllocationPort}${apiFixURLPart}GetTravelTimeforLoadAllocationForMe`,
