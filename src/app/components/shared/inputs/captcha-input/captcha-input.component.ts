...
@Component({
  ...
  imports: [InputGroupAddonModule,MessageModule,InputGroupModule,ReactiveFormsModule,NgClass],
...
export class CaptchaInputComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.captchaSrc = this.get_dummy_captcha();
  }
