...
describe('GetCaptchaService', () => {
  ...
  test('should return expected result', async () => {
    const shouldBe: CaptchaChallenge = {
      challengeId: 'cb3d7916307b7713875d7cf0fd9639e4a5qddt$oRi2A',
      imageData:
    ...
    const temp = await service.getCaptcha();
    expect(temp.data).toBe(shouldBe);
