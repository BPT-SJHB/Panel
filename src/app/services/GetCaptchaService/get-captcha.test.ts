import { GetCaptchaService } from './get-captcha.service';
import {
...
describe('GetCaptchaService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [GetCaptchaService],
    });

    service = TestBed.inject(GetCaptchaService);
    // httpMock = TestBed.inject(HttpTestingController);
  });

  test('should return expected result', () => {
    const shouldBe: IGetCaptchaApiResult = {
    ...
    const temp = service.GetApiResult();
    expect(temp).toBe(shouldBe);
